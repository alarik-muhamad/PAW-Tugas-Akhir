...
<body style="background-color: #FFF1D5;" class="font-sans">

    <!-- Navbar -->
    <div class="flex items-center justify-between bg-blue-200 px-6 py-3 text-white shadow">
    ...
    <div class="flex justify-center items-center min-h-[calc(100vh-72px)] p-4">
        <div class="bg-white rounded-xl shadow-lg flex flex-col w-full max-w-[500px] p-8">
            <h2 class="text-2xl font-bold text-blue-900 mb-6">Lupa Password</h2>
            ...
            <form method="post" class="space-y-4">
                ...
                <button type="submit" class="w-full bg-blue-800 text-white py-2 rounded hover:bg-red-800">
